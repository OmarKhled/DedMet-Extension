...
const fetchTimelineData = async (sesskey: string, cookie: string) => {
  ...
  const json = await fetch(`https://courses.nu.edu.eg/lib/ajax/service.php?sesskey=${sesskey}&info=core_calendar_get_calendar_monthly_view`, timelineFetchOptions(cookie))
